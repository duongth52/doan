                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="font-w600 text-dual" href="/">
                        ...
                        <span class="smini-hide">
                            <span class="font-w700 font-size-h5">Phòng khám nhi</span>
                        </span>
                    </a>
                    <!-- END Logo -->
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <!-- <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('examples/plugin-init') ? ' active' : '' }}" href="/examples/plugin-init">
                                        <span class="nav-main-link-name">Thêm nhân viên</span>
                                    </a>
                                </li> -->
                            </ul>
                        </li>
                        <li class="nav-main-item{{ request()->is('examples/*') ? ' open' : '' }}">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('examples/plugin-helper') ? ' active' : '' }}" href="{{route('danhsachnhanvien')}}">
                                        <span class="nav-main-link-name">Danh sách nhân viên</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('examples/plugin-init') ? ' active' : '' }}" href="{{route('addnv')}}">
                                        <span class="nav-main-link-name">Thêm nhân viên</span>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-main-item{{ request()->is('examples/*') ? ' open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" >
                                <i class="nav-main-link-icon si si-bulb"></i>
                                <span class="nav-main-link-name">Kết quả</span>
                            </a>
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('examples/plugin-helper') ? ' active' : '' }}" href="/examples/plugin-helper">
                                        <span class="nav-main-link-name">Danh sách Khoa</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('examples/plugin-init') ? ' active' : '' }}" href="/examples/plugin-init">
                                        <span class="nav-main-link-name">Thêm khoa</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
