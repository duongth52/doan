            ...
            <div class="row" style="min-width:100%; margin-top: 30px">
                <div class="col-md-4 offset-md-1">
                    ...
                    <div class="form-group">
                        ...
                        <input style="max-width: 50%" type="date" data-date-format="dd/mm/yy" name="ngaysinh" placeholder="dd/mm/yy">
                ...
                <div class="col-md-4 offset-md-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            ...
                            <!-- <input type="file" data-toggle="custom-file-input" id="example-file-input-custom" name="avatar" /> -->
